...
const Todo = () => {
  return (
    <section className="pl-20 pr-20 horizontal-pad flex flex-col pt-[56px] sm:pt-[66px] md:pt-[72px] lg:pt-[88px] lg:items-start space-y-8">
      {/* 목표 제목 */}
      <h3 className="text-5xl font-bold text-black dark:text-white ">목표</h3>

      {/* 목표 섹션 */}
      <div className="bg-white dark:bg-stone-900 rounded-3xl p-8 space-y-4">
      ...
      <div className="bg-white dark:bg-stone-900  rounded-3xl p-6 ">
